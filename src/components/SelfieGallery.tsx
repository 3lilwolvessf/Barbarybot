...
export const SelfieGallery = () => {
  return (
    <div className="w-full h-full p-4 overflow-hidden flex flex-col gap-4">
      <h3 className="font-display text-lg text-center uppercase tracking-widest text-black/40">Selfie Gallery 1906</h3>
      <div className="grid grid-cols-2 gap-3 flex-1 overflow-y-auto no-scrollbar pt-2">
        {SELFIES.map((src, i) => (
          <motion.div 
            key={i}
